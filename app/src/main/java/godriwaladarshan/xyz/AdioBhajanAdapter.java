 ...
 */
public class AdioBhajanAdapter extends RecyclerView.Adapter<AdioBhajanAdapter.CustomViewHolder>{
    ...
    public AdioBhajanAdapter(Context context, List<AudioFeedItem> feedItemList , Activity mActivity) {
    ...
    public void onBindViewHolder(final CustomViewHolder customViewHolder, int i) {
        ...
        customViewHolder.txtDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String UrlDownload = "http://www.buzzmycode.com/SindhiAppFile/audios/" + bhajanNameforDownload;
              ...
              /*  String playstop = customViewHolder.txtPlay.getText().toString();
                ...
                else if(playstop.equals("Stop"))
                {
                    ...
                    if(mediaPlayer!=null && mediaPlayer.isPlaying()){
                        mediaPlayer.stop();
                        Intent i = new Intent(mContext, AudioBhajanas.class);
                ...
                alertDialog2.setPositiveButton("STOP",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent i = new Intent(mActivity, AudioBhajanas.class);
                                mActivity.finish();
