...
public class AudioRingtone extends AppCompatActivity
    ...
    private AdioRingtoneAdapter adapter;
        ...
        audioSearch.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                if(newText !=null && newText.length() > 0){
                    ...
                    adapter = new AdioRingtoneAdapter(getApplicationContext(), filteredLists, AudioRingtone.this);
                    ...
                    mRecyclerView.setLayoutManager(mLayoutManager);
                    mRecyclerView.setItemAnimator(new DefaultItemAnimator());
                    adapter = new AdioRingtoneAdapter(getApplicationContext(), audiofeedsList, AudioRingtone.this);
                    mRecyclerView.setAdapter(adapter);
                    adapter.notifyDataSetChanged();
                }
    ...
    public class AsyncHttpTask extends AsyncTask<Void, Void, Integer> {
        ...
        protected Integer doInBackground(Void... params) {
            ...
            try {
                String url = "http://www.buzzmycode.com/Ringtone/ringtone_list.php";
        ...
        protected void onPostExecute(Integer result) {
            ...
            if (result !=0) {
                ...
                Toast.makeText(AudioRingtone.this, "Failed to fetch data!", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private AudioRingtone.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final AudioRingtone.ClickListener clickListener) {
