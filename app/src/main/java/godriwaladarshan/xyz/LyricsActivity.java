...
public class LyricsActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!cd.isConnectingToInternet()) {
            ...
            alert.showAlertDialog(LyricsActivity.this, "Internet Connection Error",
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Intent i = new Intent(LyricsActivity.this, LyricsFullImage.class);
    ...
    private JsonArrayRequest getDataFromServer(int requestCount) {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Config.LYRICS_URL + String.valueOf(requestCount),
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(LyricsActivity.this, "No More Items Available", Toast.LENGTH_SHORT).show();
                    }
                });
...
//Calling the method getdata again
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private LyricsActivity.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final LyricsActivity.ClickListener clickListener) {
