 ...
 */
public class AdioAartiAdapter extends RecyclerView.Adapter<AdioAartiAdapter.CustomViewHolder>{
    ...
    public AdioAartiAdapter(Context context, List<AudioFeedItem> feedItemList , Activity mActivity) {
    ...
    public void onBindViewHolder(final CustomViewHolder customViewHolder, int i) {
        ...
        customViewHolder.txtDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String UrlDownload = "http://www.buzzmycode.com/Aarti/Aarti/" + bhajanNameforDownload;
              ...
              /*  String playstop = customViewHolder.txtPlay.getText().toString();
                ...
                else if(playstop.equals("Stop"))
                {
                    ...
                    if(mediaPlayer!=null && mediaPlayer.isPlaying()){
                        mediaPlayer.stop();
                        Intent i = new Intent(mContext, AudioAarti.class);
                ...
                alertDialog2.setPositiveButton("STOP",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent i = new Intent(mActivity, AudioAarti.class);
                                mActivity.finish();
                ...
                String UrlPlay = "http://www.buzzmycode.com/Aarti/Aarti/" + bhajanNameforPlay;
