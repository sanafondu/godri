...
public class AudioAarti extends AppCompatActivity
    ...
    private AdioAartiAdapter adapter;
        ...
        audioSearch.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                if(newText !=null && newText.length() > 0){
                    ...
                    adapter = new AdioAartiAdapter(getApplicationContext(), filteredLists, AudioAarti.this);
                    ...
                    mRecyclerView.setLayoutManager(mLayoutManager);
                    mRecyclerView.setItemAnimator(new DefaultItemAnimator());
                    adapter = new AdioAartiAdapter(getApplicationContext(), audiofeedsList, AudioAarti.this);
                    mRecyclerView.setAdapter(adapter);
                    adapter.notifyDataSetChanged();
                }
    ...
    public class AsyncHttpTask extends AsyncTask<Void, Void, Integer> {
        ...
        protected Integer doInBackground(Void... params) {
            ...
            try {
                String url = "http://www.buzzmycode.com/Aarti/aarti_list.php";
        ...
        protected void onPostExecute(Integer result) {
            ...
            if (result !=0) {
                ...
                Toast.makeText(AudioAarti.this, "Failed to fetch data!", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private AudioAarti.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final AudioAarti.ClickListener clickListener) {
